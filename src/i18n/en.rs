...
pub(super) fn text(key: Key) -> &'static str {
    match key {
        ...
        Key::ShortcutFullscreen => "Full screen",
        Key::WindowMinimize => "Minimize",
        Key::WindowMaximize => "Maximize",
        Key::WindowRestore => "Restore",
        ...
        Key::ToastCopyImageFailed => "Could not copy the image",

...
pub(super) fn text(key: Key) -> &'static str {
    match key {
        ...
        Key::SettingsHistoryCurrentHint => "Descarga mensajes y archivos anteriores solo del chat abierto.",
        Key::SettingsHistoryRecentHint => "Descarga historial anterior de los chats fijados y de los diez más recientes.",
        ...
        Key::SettingsLanguageHint => "Se aplica a toda la interfaz. Los menús de la bandeja del sistema cambian al reiniciar.",
        ...
        Key::SettingsThemeSystemHint => "Seguir el sistema usa el modo claro u oscuro de tu escritorio.",
        Key::SettingsOpenThemesFolder => "Abrir carpeta de temas",
        Key::SettingsWallpaperLabel => "Fondo de chat",
        Key::SettingsWallpaperHint => "Automático elige un fondo según los colores del tema. Puedes forzar de Negro 1 a Blanco 3. Haz clic derecho en el chat abierto y elige Siguiente fondo para recorrer los tres fondos de esa familia.",
        ...
        Key::SettingsEnterSendsHint => "Si está desactivado, Enter añade una línea y Ctrl+Enter envía.",
        Key::SettingsReceiptsOffNote => "Las confirmaciones de lectura están desactivadas en tu cuenta de WhatsApp (Ajustes, Privacidad). Los chats directos no las envían. Con este interruptor activado, los grupos sí. El estado de lectura se sincroniza entre tus dispositivos igual.",
        Key::SettingsReceiptsOnNote => "Deja que los demás vean cuándo lees mensajes o reproduces mensajes de voz en esta copia. El ajuste de tu cuenta de WhatsApp en Privacidad sigue aplicando. El estado de lectura se sincroniza entre tus dispositivos igual.",
        ...
        Key::SettingsAutoDownloadHint => "Descarga fotos, videos, mensajes de voz y documentos de hasta 64 MB cuando entran en pantalla. Si está desactivado, haz clic en un archivo para descargarlo.",
        Key::SettingsHistoryLabel => "Descargar historial anterior en segundo plano",
        Key::SettingsHistoryHint => "Descarga despacio los mensajes anteriores y sus archivos (hasta 64 MB) para que desplazarte hacia arriba no choque con el límite de WhatsApp. Los archivos que fallan se vuelven a pedir tras una espera larga, hasta 30 días. Recientes y fijados abarca cada chat fijado más los diez chats activos más recientes que no estén fijados.",
        ...
        Key::SettingsNamesFromContactsHint => "Prefiere los nombres guardados en tu agenda. Si está desactivado, prefiere los nombres públicos del perfil de WhatsApp. Se aplica en toda la app.",
        Key::SettingsSaveContacts => "Guardar contactos en la agenda del teléfono",
        Key::SettingsSaveContactsHint => "También añade a la agenda del teléfono los contactos guardados aquí. Si está desactivado, quedan como contactos de WhatsApp. Los nombres se sincronizan entre dispositivos igual.",
        Key::SettingsForwardInOrder => "Reenviar mensajes en orden",
        Key::SettingsForwardInOrderHint => "Envía un reenvío múltiple de a un mensaje, y empieza cada uno cuando el anterior muestra su primer tilde. Así el texto, las fotos y los videos mezclados llegan en su orden original. Si está desactivado, se envían juntos y pueden llegar desordenados.",
        Key::SettingsShowPollButton => "Mostrar el botón Crear encuesta",
        Key::SettingsShowPollButtonHint => "Añade el botón Crear encuesta junto al cuadro de mensaje. Si está desactivado, el botón se oculta y las encuestas que ya están en un chat siguen funcionando.",
        Key::SettingsShowShortcutHints => "Mostrar sugerencias de atajos",
        Key::SettingsSectionDownloads => "Descargas",
        Key::SettingsStorageHint => "Peso de las fotos, videos, stickers y GIF que ya están en este equipo. El recuento de mensajes incluye el texto.",
        ...
        Key::SettingsPrivacyLoadFailed => "No se pudo cargar la privacidad. Vuelve a cargarse cuando WhatsFast se reconecte.",
        Key::SettingsSectionWindow => "Ventana",
        Key::SettingsKeepRunning => "Seguir activo al cerrar la ventana",
        Key::SettingsKeepRunningHint => "Mantiene WhatsFast vinculado en la bandeja del sistema. Sal de la bandeja o con Ctrl+Q.",
        Key::SettingsNotify => "Notificar mensajes nuevos",
        Key::SettingsNotifyHint => "Muestra notificaciones del escritorio cuando la ventana está oculta, en segundo plano o mostrando otro chat. Los chats silenciados no notifican.",
        Key::SettingsHideSidebar => "Ocultar la barra lateral por completo",
        Key::SettingsHideSidebarHint => "Activado: ocultar la barra lateral (Ctrl+B) no deja nada. Desactivado: se reduce a las fotos de los chats, así la búsqueda, los chats archivados y los ajustes quedan a un clic.",
        Key::SettingsGiphyKey => "Clave de API de GIPHY",
        Key::SettingsGiphyKeyHintBuiltIn => "Se usa para buscar GIF. Esta compilación incluye una clave. Ingresa una clave de developers.giphy.com para reemplazarla.",
        Key::SettingsGiphyKeyHintRequired => "Necesaria para buscar GIF. Consigue una clave gratis en developers.giphy.com.",
        ...
        Key::SettingsAskWhereToSaveHint => "Abre el diálogo de guardado del sistema para cada adjunto que guardas desde la barra de selección, así eliges la carpeta y el nombre del archivo. Si está desactivado, los archivos van a tu carpeta de Descargas.",
        Key::SettingsLogOfRun => "Registro de esta ejecución",
        Key::SettingsSectionAbout => "Acerca de",
        Key::SettingsAboutLine => "Un cliente de WhatsApp nativo hecho con Rust, egui y whatsapp-rust.",
        Key::SettingsCheckUpdates => "Buscar actualizaciones",
        Key::SettingsCheckUpdatesHint => "Consulta a GitHub una vez al día si hay una versión más nueva de WhatsFast. La solicitud identifica solo a WhatsFast y su versión.",
        Key::SettingsDownloadUpdates => "Descargar actualizaciones automáticamente",
        Key::SettingsDownloadUpdatesHint => "Descarga y verifica versiones nuevas en segundo plano. Un aviso ofrece Actualizar; con un clic se instala y se reinicia. Si ignoras el aviso, la próxima vez que abras WhatsFast se instala el archivo verificado. Los paquetes nativos y Flatpak se actualizan con su gestor de paquetes.",
        ...
        Key::ShortcutPhotoViewerKeys => "La rueda acerca, el arrastre mueve, ← / → foto anterior o siguiente",
        ...
        Key::LoginUnlinkedRequestingCode => "Este equipo se desvinculó de tu teléfono. Se está pidiendo un código nuevo.",
        ...
        Key::LoginUnofficialWarning => "Cliente no oficial. Usarlo puede ir contra los términos de servicio de WhatsApp.",
        ...
        Key::LoginTapLinkDevice => "Toca Vincular un dispositivo y apunta el teléfono a este código",
        ...
        Key::LoginTapLinkPhone => "Toca Vincular un dispositivo y luego Vincular con un número de teléfono",
        ...
        Key::PickerGiphyKeyRejected => "GIPHY rechazó esta clave de API. Crea una clave gratis en developers.giphy.com y pégala aquí. Se guarda en tus ajustes.",
        Key::PickerGiphyKeyNeeded => "La búsqueda de GIF necesita una clave de API de GIPHY. Crea una clave gratis en developers.giphy.com y pégala aquí. Se guarda en tus ajustes.",
        Key::PickerStickersLoading => "Cargando tus stickers…",
        Key::PickerStickersEmpty => "Los stickers recientes aparecen aquí. Haz clic derecho en uno para guardarlo. Para importar un paquete, pega un enlace de signal.art o abre un archivo .wastickers.",
        ...
        Key::DialogAboutLine => "Un cliente de WhatsApp nativo escrito en Rust con egui. Se conecta a través de whatsapp-rust. Los mensajes están cifrados de extremo a extremo en este dispositivo.",
        Key::DialogUnofficialWarning => "Este es un cliente no oficial. Usarlo puede ir contra los términos de servicio de WhatsApp y podría suspender una cuenta.",
        Key::DialogSourceCode => "Código fuente",
        Key::DialogVersion => "Versión {version}",
        Key::DialogUnlinkTitle => "¿Desvincular este equipo?",
        Key::DialogUnlinkBody => "Esto quita el dispositivo de WhatsApp y elimina los chats guardados aquí. Puedes vincular de nuevo con un código nuevo.",
        ...
        Key::DialogLeaveBody => "No recibirás mensajes nuevos. El historial local queda en este equipo.",
        ...
        Key::DialogPhoneInstructions => "Escribe el número de teléfono de WhatsApp con su código de país. No incluyas el signo más ni un cero inicial. Recibirás un código para escribir en el teléfono.",
        Key::DialogGetCode => "Obtener un código",
        Key::DialogNewContactTitle => "Contacto nuevo",
        Key::DialogNewContactBody => "Escribe un número de teléfono con su código de país, sin el signo más ni un cero inicial. Añade un nombre para guardar el contacto, o déjalo en blanco para abrir el chat. WhatsApp usa el nombre de pila como nombre visible.",
        ...
        Key::ChatListNoScheduledHint => "Escribe un mensaje y elige una hora con el reloj junto al botón Enviar.",
        Key::ChatListNoStarred => "No hay mensajes destacados",
        Key::ChatListNoStarredHint => "Elige mensajes en un chat y pulsa Destacar para guardarlos aquí.",
        ...
        Key::ChatListNothingInListHint => "Haz clic derecho en este filtro y elige Editar para añadir chats.",
        Key::ChatListNoChats => "Aún no hay chats",
        Key::ChatListNoChatsHint => "Los chats nuevos aparecen aquí. Puedes iniciar uno desde tu teléfono.",
        ...
        Key::ChatHintsEnter => "Enter envía · Shift+Enter para una línea nueva · *negrita* _cursiva_ ~tachado~ · Ctrl+V pega una imagen",
        Key::ChatHintsCtrlEnter => "Ctrl+Enter envía · *negrita* _cursiva_ ~tachado~ · Ctrl+V pega una imagen",
        ...
        Key::DialogDigitsOnly => "Escribe el número de teléfono con su código de país, solo con dígitos",
        ...
        Key::ChatRetryFile => "Seguimos intentando conseguir este archivo automáticamente. Haz clic para reintentar.",
        ...
        Key::PrivacyReceiptsHint => "Todos o nadie en tu cuenta de WhatsApp. El interruptor de Chats sigue aplicando a esta copia.",
        ...
        Key::PollErrDisappearing => "Aún no se pueden crear encuestas en chats con mensajes que desaparecen.",
        ...
        Key::PollErrKeyNotSaved => "La encuesta se envió, pero no se pudo guardar su clave de votación.",
        Key::PollErrNotReady => "Esta encuesta todavía no está lista para votar. Vuelve a conectar e inténtalo de nuevo.",
        ...
        Key::ToastNoOlder => "Tu teléfono no envió mensajes anteriores. Comprueba que esté en línea",
        ...
        Key::ToastForwardNoData => "Los datos del mensaje original no están disponibles para reenviar",
        ...
        Key::ToastRecipientsSaveFailed => "No se pudieron guardar los destinatarios del mensaje de grupo",
        ...
        Key::ErrClientOutdated => "WhatsApp rechazó esta versión de WhatsFast. Actualiza la aplicación",
        ...
        Key::StickerErrMissingPackKey => "Falta pack_key o no es válido. Copia el enlace completo de signal.art",
        ...
        Key::UpdFlatpak => "Actualiza esta instalación desde tu centro de software o con flatpak update.",
        ...
        Key::UpdThrough => "Actualiza esta instalación con {instruction} o desde tu centro de software.",
        Key::UpdSystemDir => "Esta instalación está en una carpeta del sistema. Usa tu gestor de paquetes o la página de descarga.",
        Key::UpdNoInstallDir => "La aplicación no tiene carpeta de instalación",
        Key::UpdNotPortable => "Esta instalación no se identifica como descarga portátil. Usa la página de descarga para instalar una versión que se pueda actualizar.",
        ...
        Key::UpdStartupCheckNoAnswer => "La aplicación descargada no respondió a la prueba de arranque",
        ...
        Key::UpdStagedChecksumChanged => "Cambió la suma de verificación de la actualización preparada",
        ...
        Key::UpdInstallerFailed => "Falló el instalador. Revisa el registro del instalador de la actualización.",
        ...
        Key::UpdFailedRestored => "Falló la actualización; se restauró la aplicación anterior: {error}",
        Key::UpdUpdatedTo => "Actualizado a {version}",
        Key::UpdCouldNotStartRestored => "La actualización no pudo empezar. Se restauró la versión anterior.",
        ...
        Key::UpdMissingChecksum => "A la publicación le falta la suma de verificación de la actualización",
        Key::UpdInvalidReleaseVersion => "Versión de la publicación inválida",
        Key::UpdRedirectNotAllowed => "No se permite una redirección en la descarga de la actualización",
        Key::UpdReleaseChanged => "La publicación cambió. Busca actualizaciones de nuevo.",
        Key::UpdUseDownloadPage => "Usa la página de descarga para este sistema operativo o arquitectura",
        Key::UpdNotOnReleaseHost => "La descarga de la actualización no está en el servidor de la publicación",
        Key::UpdAssetOtherRelease => "El archivo de la actualización no pertenece a esta publicación",
        ...
        Key::UpdCouldNotVerifyDownload => "No se pudo verificar la descarga. Intenta descargarla de nuevo.",
        Key::UpdMoveToApplications => "Mueve la aplicación a Aplicaciones y ábrela para actualizar.",
        ...
        Key::ThemeErrRegularFile => "se esperaba un archivo normal, no una carpeta ni un enlace simbólico",
        Key::ThemeErrTooBig => "el tema supera el límite de 64 KiB",
        Key::ThemeErrUtf8 => "se esperaba JSON en UTF-8",
        Key::ThemeErrFolderUnreadable => "No se pudo leer la carpeta de temas. Mira el registro para más detalles.",
        Key::ThemeErrTooManyEntries => "La carpeta de temas tiene más de 512 entradas. Deja menos archivos ahí para listar los temas personalizados.",
        Key::ThemeErrTooManyThemes => "Solo se pueden listar 128 temas personalizados. Deja menos archivos JSON en la carpeta de temas para ver el resto.",
        Key::ThemeErrOmarchyLoad => "No se pudo cargar la paleta de Omarchy. Se mantiene el último aspecto que funcionó. Mira el registro para más detalles.",
        Key::ThemeErrReload => "No se pudieron cargar los temas personalizados. Ejecuta whatsfast reload-themes para reintentar.",
        Key::ThemeLoadingLocal => "Cargando temas locales…",
        Key::ThemeErrSelectedUnavailable => "El tema elegido no está disponible. Se mantiene el último aspecto que funcionó. Mira el registro para más detalles.",
        ...
        Key::ArchiveErrBadKeyringKey => "La clave del archivo en el llavero del sistema no es válida",
        ...
        Key::ArchiveErrKeyringOpen => "El llavero del sistema no pudo abrir la clave del archivo de WhatsFast",
        Key::ArchiveErrKeySaveMigrated => "No se pudo guardar la clave migrada del archivo en el llavero del sistema",
        Key::ArchiveErrKeyMissing => "El archivo está cifrado pero falta su clave en el llavero del sistema. Restaura el llavero original; el archivo no cambió",
        Key::ArchiveErrKeyGenerate => "No se pudo generar una clave para el archivo",
        Key::ArchiveErrKeySave => "No se pudo guardar la clave del archivo en el llavero del sistema",
        ...
        Key::ArchiveErrUnlockFailed => "No se pudo desbloquear el archivo con su clave del llavero del sistema",
        Key::ArchiveErrClosePrograms => "Cierra los otros programas que usan el archivo antes de migrarlo",

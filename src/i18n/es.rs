...
pub(super) fn text(key: Key) -> &'static str {
    match key {
        ...
        Key::ShortcutFullscreen => "Pantalla completa",
        Key::WindowMinimize => "Minimizar",
        Key::WindowMaximize => "Maximizar",
        Key::WindowRestore => "Restaurar",
        ...
        Key::ChatDraftPreview => "Borrador: {text}",
        ...
        Key::ChatCopyImage => "Copiar imagen",
        ...
        Key::ToastCopyImageFailed => "No se pudo copiar la imagen",
